...
func Update(port string, baud int, firmwareHex []byte, cb func(format string, values ...interface{})) error {
	...
	cb("%s %s", "Done in", time.Since(start).Round(10*time.Millisecond).String())
	return nil
}
